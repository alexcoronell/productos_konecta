    ...
    <div class="row">
        <div class="col">
            <form name="formulario" id="formulario" method="POST">
                ...
                <!-- Categoría -->
                <div class="mb-3">
                <label for="id_categoria" class="col-12 col-lg-4 mt-md-2">Categoria:</label>
                <select name="id_categoria" id="id_categoria" class="form-control selectpicker" title="Seleccione...">
                </select>
                </div>
                <!-- Stock -->
                <div class="mb-3">
